...
const allColorButtons = (props: Partial<ButtonProps>) => {
  return (
    <StorybookContainer>
      <Box paddingY={1}>
        <Button text="Default" onClick={() => console.log("clicked")} {...props} />
      </Box>
      <Box paddingY={1}>
        <Button
          color="primary"
      ...
      <Box paddingY={1}>
        <Button color="secondary" text="Secondary" onClick={() => console.log("clicked")} {...props} />
      </Box>
      <Box paddingY={1}>
        <Button color="tertiary" text="Tertiary" onClick={() => console.log("clicked")} {...props} />
      </Box>
      <Box paddingY={1}>
        <Button color="accent" text="Accent" onClick={() => console.log("clicked")} {...props} />
      </Box>
      <Box paddingY={1}>
        <Button color="red" text="Red" onClick={() => console.log("clicked")} {...props} />
      </Box>
      <Box paddingY={1}>
        <Button color="darkGray" text="Dark Gray" onClick={() => console.log("clicked")} {...props} />
      </Box>
      <Box paddingY={1}>
        <Button color="gray" text="Gray" onClick={() => console.log("clicked")} {...props} />
      </Box>
      <Box paddingY={1}>
        <Button
          color="primary"
