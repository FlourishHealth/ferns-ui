 ...
 * ```
 */
export declare type MessagePushStatus = {
    userId?: User["_id"] | User;
    ticketStatus?: "ok" | "error";
    ticketId?: string;
    ticketErrorMessage?: string;
    ticketErrorType?: "DeviceNotRegistered" | "InvalidCredentials" | "MessageTooBig" | "MessageRateExceeded";
 ...
 * ```
 */
export declare type MessageObject = Message;
/**
 ...
 * ```
 */
export declare type MessageModel = mongoose.Model<MessageDocument, MessageQueries> & MessageStatics;
/**
 ...
 * ```
 */
export declare type MessageSchema = mongoose.Schema<MessageDocument, MessageModel>;
/**
 * Mongoose Subdocument type
 *
 * Type of `MessageDocument["pushStatuses"]` element.
 */
export declare type MessagePushStatusDocument = mongoose.Types.Subdocument & {
 ...
 * ```
 */
export declare type MessageDocument = mongoose.Document<mongoose.Types.ObjectId, MessageQueries> & MessageMethods & {
    text?: string;
 ...
 * ```
 */
export declare type ConversationObject = Conversation;
/**
 * Mongoose Query types
 *
 * Pass this type to the Mongoose Model constructor:
 ...
 * ```
 */
export declare type ConversationQueries = {};
export declare type ConversationMethods = {
    sendMessage: (this: ConversationDocument, message: MessageDocument) => Promise<void>;
    sendPushNotifications: (this: ConversationDocument, message: MessageDocument, members: ConversationMember[]) => Promise<void>;
...
export declare type ConversationStatics = {
    createConversationForUser: (this: ConversationModel, user: ConversationUser, extraData: any) => void;
    getPushDataForMember: (this: ConversationModel, message: MessageDocument, member: any) => {
        to: string;
        sound: string;
        body: string;
        data: {
    ...
    sendMessageToMember: (this: ConversationModel, message: MessageDocument, member: any) => Promise<void>;
};
/**
 * Mongoose Model type
 *
 ...
 * ```
 */
export declare type ConversationModel = mongoose.Model<ConversationDocument, ConversationQueries> & ConversationStatics;
/**
 * Mongoose Schema type
 *
 ...
 * ```
 */
export declare type ConversationSchema = mongoose.Schema<ConversationDocument, ConversationModel>;
/**
 * Mongoose Subdocument type
 *
 * Type of `ConversationDocument["members"]` element.
 */
export declare type ConversationMemberDocument = mongoose.Types.Subdocument & {
    userId: UserDocument["_id"] | UserDocument;
    _id: mongoose.Types.ObjectId;
};
/**
 ...
 * ```
 */
export declare type ConversationDocument = mongoose.Document<mongoose.Types.ObjectId, ConversationQueries> & ConversationMethods & {
 ...
 * ```
 */
export declare type PopulatedDocument<DocType, T> = T extends keyof DocType ? PopulatedProperty<DocType, T> : ParentProperty<T> extends keyof DocType ? Omit<DocType, ParentProperty<T>> & {
