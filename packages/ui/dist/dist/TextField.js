...
export class TextField extends React.Component {
    ...
    renderIcon() {
        ...
        if (this.props.searching === true) {
            return (React.createElement(Box, { marginRight: 4 }, React.createElement(ActivityIndicator, { color: Unifier.theme["primary"], size: "small" })));
        }
        else {
            return (React.createElement(Box, { marginRight: 2 }, React.createElement(Icon, { prefix: "far", size: 14, name: "search" })));
        }
    }
    focus() {
        // Empty
    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null, React.createElement(WithLabel, { label: errorMessage, labelPlacement: "after", labelColor: this.props.errorMessageColor || "red", labelSize: "sm" }, React.createElement(WithLabel, Object.assign({}, props), React.createElement(View, { onTouchEnd: () => {
                ...
                overflow: "hidden",
            } }, this.renderIcon(), React.createElement(TextInput, { style: Object.assign({ flex: 1, paddingTop: 10, paddingRight: 10, paddingBottom: 10, paddingLeft: 0, height: this.getHeight(), width: "100%", color: Unifier.theme.darkGray, fontFamily: Unifier.theme.primaryFont,
            ...
            }, blurOnSubmit: true, returnKeyType: type === "number" || type === "decimal" ? "done" : this.props.returnKeyType, autoFocus: this.props.autoFocus, multiline: this.props.multiline, numberOfLines: this.props.rows || 4 })))), this.props.type === "date" && (React.createElement(DateTimeActionSheet, { actionSheetRef: this.dateActionSheetRef, mode: "date", value: this.props.value, onChange: (result) => this.props.onChange(result) })), this.props.type === "numberRange" && this.props.value && (React.createElement(NumberPickerActionSheet, { actionSheetRef: this.numberRangeActionSheetRef, min: this.props.min || 0, max: this.props.max || (this.props.min || 0) + 100, value: this.props.value, onChange: (result) => this.props.onChange(result) })), this.props.type === "decimalRange" && this.props.value && (React.createElement(DecimalRangeActionSheet, { actionSheetRef: this.decimalRangeActionSheetRef, min: this.props.min || 0, max: this.props.max || (this.props.min || 0) + 100, value: this.props.value, onChange: (result) => this.props.onChange(result) })), this.props.type === "height" && (React.createElement(HeightActionSheet, { actionSheetRef: this.weightActionSheetRef, value: this.props.value, onChange: (result) => {
