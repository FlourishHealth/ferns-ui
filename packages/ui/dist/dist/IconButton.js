...
export class IconButton extends React.Component {
    render() {
        ...
        return (React.createElement(TouchableOpacity, { onPress: () => {
                ...
                alignItems: "center",
            }, hitSlop: { top: 10, left: 10, bottom: 10, right: 10 } }, React.createElement(Icon, { prefix: this.props.prefix || "fas", size: iconSizeToNumber(this.props.size), name: this.props.icon, color: this.props.iconColor })));
    }
}
