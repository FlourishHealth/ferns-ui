...
export class DecimalRangeActionSheet extends React.Component {
    ...
    render() {
        return (React.createElement(ActionSheet, { ref: this.props.actionSheetRef, gestureEnabled: true, bounceOnOpen: true }, React.createElement(Box, { width: "100%", paddingX: 4, marginBottom: 8 }, React.createElement(Box, { width: "100%", display: "flex", alignItems: "end" }, React.createElement(Box, { width: "33%" }, React.createElement(Button, { type: "ghost", text: "Close", color: "blue", size: "lg", onClick: () => {
                var _a, _b;
                (_b = (_a = this.props.actionSheetRef) === null || _a === void 0 ? void 0 : _a.current) === null || _b === void 0 ? void 0 : _b.setModalVisible(false);
            } }))), React.createElement(Box, { width: "100%", direction: "row" }, React.createElement(Box, { width: "50%" }, React.createElement(Picker, { style: {
        ...
        }))), React.createElement(Box, { width: "50%" }, React.createElement(Picker, { style: {
                height: PICKER_HEIGHT,
                backgroundColor: "#FFFFFF",
            }, itemStyle: {
                height: PICKER_HEIGHT,
