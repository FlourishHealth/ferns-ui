...
export class CheckBox extends React.Component {
    ...
    render() {
        return (React.createElement(Box, { paddingY: 1, display: "flex", direction: "row", maxHeight: 60, width: "100%", alignItems: "center" },
            React.createElement(Box, { display: "flex", justifyContent: "center", width: this.props.size === "sm" ? 14 : 20, maxWidth: this.props.size === "sm" ? 14 : 20 }, this.renderCheckBox()),
